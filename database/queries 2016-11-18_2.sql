...
GROUP BY pu.id, pu.code, date, pu.registered_at, po.supplier_id,supplier, c.id, c.name, bd.branch_id, po.id, purchase_order_id, purchase_order, s.id;
