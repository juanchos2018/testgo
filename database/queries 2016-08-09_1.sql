/* Alterando función save_purchase para guardar si la compra está consignada */
...
BEGIN
    ...
    INSERT INTO purchases (input_date, amount, branch_detail_id, supplier_id, purchase_order_id, utility, currency, expenses, approved_state, approved_by, approved_at, registered_by, consigned)
    VALUES (
        ($1->>'input_date')::DATE,
        ($1->>'amount')::REAL,
