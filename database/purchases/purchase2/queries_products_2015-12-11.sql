...
(description, brand_id, subcategory_id, category_id, uses_id, ages_id, gender_id, measurement_id, code, regime)
VALUES
(
'${this.DESCRIPCION}',
 (SELECT brands.id FROM brands WHERE brands.description = '${this.MARCA}'),
  (SELECT subcategories.id FROM subcategories WHERE subcategories.description = '${this["DESCRIP ADICIONAL"]}'),
