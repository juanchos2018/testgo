/* Eliminando referencia a ofertas de función save_sale para guardar ventas manuales */
...
BEGIN
	...
	LOOP
		INSERT INTO sale_details (
			...
			CASE WHEN (sale_detail->>'pack_list_id') IS NULL THEN NULL ELSE (sale_detail->>'pack_list_id')::INTEGER END
		);
