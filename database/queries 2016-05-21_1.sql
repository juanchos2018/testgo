/* Función para registrar tablas independientes de productos (para pedidos y compras) */
CREATE OR REPLACE FUNCTION save_single_tables(
	CHARACTER VARYING[], /* categories */
	CHARACTER VARYING[], /* genders */
	CHARACTER VARYING[], /* ages */
	CHARACTER VARYING[], /* uses */
	CHARACTER VARYING[], /* brands */
	CHARACTER VARYING[] /* subcategories */
