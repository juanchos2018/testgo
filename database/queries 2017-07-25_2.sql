/* Editando vista v_purchases_details para mostrar detalle de compra con codigo de barra GENERADO POR EL SISTEMA */
...
SELECT
	...
	p.regime,
	p.output_statement,
	i.serie AS invoice_number,
	i.date AS invoice_date
FROM purchase_details pud
INNER JOIN invoices i ON pud.invoice_id = i.id
