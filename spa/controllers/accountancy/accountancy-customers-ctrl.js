window.angular.module('ERP').controller('AccountancyCustomersCtrl', [
    ...
    function ($scope, $window, Page, Ajax, FileHandler) {
        ...
        $scope.getData = function () {
            Ajax.get($window.siteUrl('accountancy/get_customers')).then(function (res) {
                var date = moment();
