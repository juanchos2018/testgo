        ...
        <section class="panel panel-default">
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        <p class="pull-left">
                           <!--  <a ng-href="#/brands/edit/{{selected[0].id}}" class="btn btn-default" ng-disabled="selected.length !== 1">
                        ...
                        <p class="pull-right">
                            <a href="#/brands/add" class="btn btn-success">
                                <i class="fa fa-plus text"></i>
                                <span class="text">&nbsp;Agregar</span>
                            </a>
                            <a href="#/brands/trash" class="btn btn-default">
                    ...
                    <div class="col-sm-12">
                        <?php echo erp_datatable(
                            ...
                            array(
                                ...
                                'fields' => array('{{brand.description}}')
                            ),
                            'multiple',
                            'selected'
                        ); ?>
...
<script>
    angularScope(function ($scope) {
        ...
        if (records) {
            $scope.brands = records.extendEach({selected: false});
        }
    });
</script>
