    ...
    <form class="form-horizontal" ng-submit="submit()" autocomplete="off">
        <div class="col-sm-6">
            <div class="form-group required">
                ...
                <div class="col-sm-5">
                    <select class="form-control" ng-model="record.company_id" ng-options="c.id as c.text for c in companies" required>
        ...
        <div class="col-sm-6">
            <div class="form-group required">
                ...
                <div class="col-sm-5">
                    <select class="form-control" ng-model="record.voucher" ng-options="v as v for v in vouchers" required>
                        <option value="">- Seleccione -</option>
                    </select>
                </div>
            </div>
        ...
        <div class="col-sm-6">
            <div class="form-group required">
                ...
                <div class="col-sm-3">
                    <input class="form-control text-right" ng-model="record.serie" required>
                </div>
            </div>
        </div>
