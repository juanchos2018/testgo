          ...
          <section class="panel panel-default">
              ...
              <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        <select class="form-control" ng-model="user.company_id" ng-options="company.id as company.text for company in companies" ng-change="user.branch_id = ''">
                          <option value="">-- Todas --</option>
                        </select>
                      </div>
                    </div>
                    
                    <div class="line line-dashed b-b line-lg pull-in" ng-if="user.company_id"></div>
            ...
            <div class="panel-body">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-md-6">
                      <input type="password" class="form-control" id="new-password" required ng-model="credentials.password" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                  <div class="col-lg-offset-2 col-lg-10">
                      <div class="checkbox i-checks">
                          <label>
                              <input type="checkbox" ng-init="showPassword = false" ng-model="showPassword" ng-change="changeShowPwd()" tabindex="-1"><i></i> Mostrar contraseña
                          </label>
                      </div>
                  </div>
              </div>
              
              <div class="line line-dashed b-b line-lg pull-in" ng-if="!showPassword"></div>
              
              <div ng-class="credentials.password.length && credentials.repassword.length && credentials.password !== credentials.repassword ? ['form-group', 'required', 'has-error'] : 'form-group required'" ng-if="!showPassword">
                <label class="col-sm-2 control-label">Repita contraseña</label>
                <div class="col-sm-10">
                  <div class="row">
                    <div class="col-md-6">
                      <input type="password" class="form-control" id="re-password" required ng-model="credentials.repassword" />
                      <span class="help-block m-b-none text-danger" ng-if="credentials.password.length && credentials.repassword.length && credentials.password !== credentials.repassword">Las contraseñas no coinciden</span>
                    </div>
                  </div>
                </div>
              </div>
