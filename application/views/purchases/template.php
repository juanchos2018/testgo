	...
	<form ng-submit="generate()">
		<div class="row m-b-xs">
			<div class="col-lg-12">
				<div class="radio i-checks">
					<label>
						<input type="radio" ng-value="'purchase_order'" ng-model="source">
						<i></i> Para llegada de pedido
					</label>
				</div>
			</div>
			<div class="col-lg-12">
				<div style="padding-left: 25px" ng-show="source === 'purchase_order'" class="slidedown-anim">
					<div class="row m-b-xs">
						<div class="col-lg-6">
							<select select2="purchaseOrderSelect2" ng-model="purchaseOrder.id" class="form-control">
								<option value=""></option>
							</select>
						</div>
					</div>
					...
					<div class="row m-b-xs m-t-sm">
						<div class="col-lg-12">
							<div class="checkbox i-checks">
								<label>
									<input type="checkbox" ng-model="purchaseOrder.onlyStock">
									<i></i> Sólo productos con stock pendiente
								</label>
							</div>
						</div>
					</div>
		...
		<div class="row m-t-sm">
			<div class="col-lg-12">
				<div class="radio i-checks">
					<label>
						<input type="radio" ng-value="'products'" ng-model="source">
						<i></i> Incluir registros de productos
					</label>
				</div>
			</div>
			<div class="col-lg-12">
				<div style="padding-left: 25px" ng-show="source === 'products'" class="slidedown-anim">
					<div class="row m-b-xs">
						<div class="col-lg-2">
							<div class="checkbox i-checks">
								<label>
					...
					<div class="row m-b-xs m-t-sm">
						<div class="col-lg-12">
							<div class="checkbox i-checks">
								<label>
									<input type="checkbox" ng-model="onlyStock">
									<i></i> Sólo productos con stock mayor a cero
								</label>
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-sm-6 m-b-none m-t-lg text-center">
				<button class="btn btn-primary" ng-disabled="(source === 'purchase_order' &amp;&amp; !purchaseOrder.id) || downloading || (filterShown &amp;&amp; !filters.length)">Generar</button>
			</div>
			<div class="col-sm-6 m-b-none m-t-lg text-center">
				<a class="btn btn-default" href="<?php echo base_url('public/files/templates/purchase.xlsx'); ?>" download="pedido_<?php echo date('d-m-Y_His'); ?>.xlsx" ng-click="downloadBlank($event)">Descargar plantilla en blanco</a>
			</div>
	    </div>
	</form>
</section>
