<section class="wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="text" ng-model="paymentDate" class="form-control text-center" disabled>
                </div>
            </div>
        						...
        						<tbody>
        							<tr each="{ row, index in data }">
        								...
        								<td class="v-middle text-center">
                                            <strong>{ row['CANT.'] || 0 }</strong>
                                        </td>
        								<td class="v-middle text-center">
                                            <span class="text-primary">{ row.arrived_quantity || 0 }</span>
                                        </td>
        								<td class="v-middle text-center">
    ...
    <div class="row m-t">
		<div class="col-lg-12 text-center" style="clear:both">
            ...
            <a href="#/purchase-orders/edit/{{ id }}" class="btn btn-default">Editar</a>
