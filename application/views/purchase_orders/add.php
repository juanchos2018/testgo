<section class="wrapper">
    ...
    <form class="m-b-lg" ng-submit="finish()" autocomplete="off" id="new-purchase-order">
        <div class="row">
            ...
            <div class="col-sm-9 col-md-7">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" ng-model="description" ng-readonly="saving" required>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <erp-company-chooser class="form-control" required ng-model="company" ng-readonly="saving" data-show-empty="false" data-select-first ng-change="changeCompany()"></erp-company-chooser>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <erp-supplier-chooser required="true" data-model="supplierId" disabled="saving" data-placeholder="- Seleccione -"></erp-supplier-chooser>
                </div>
            </div>
        							...
        							<tr each="{ row, index in data }">
        								...
        								<td class="v-middle">
                                            ...
                                            <div if="{ row.product_detail_id }" class="input-group">
                                                <span class="input-group-addon">{ row.MONEDA_FACTURA }</span>
    ...
    <div class="row m-t">
		<div class="col-lg-12 text-center" style="clear:both">
        	...
        	<button class="btn btn-primary" type="submit" ng-disabled="stage !== 'data'" form="new-purchase-order">
        	    Guardar
        	</button>
        </div>
    </div>
